...
This research instinct extends into my independent and competition work: I fine-tuned IndoBERT for Indonesian clickbait headline classification (Top 10 Finalist, Gemastik 2023), and proposed a multimodal architecture fusing video, audio, and Whisper-transcribed text via ViT-LSTM and IndoBERT for emotion detection at Satria Data 2025, with the text-only ablation reaching 0.6975 micro-F1 on an 8-class multilabel task. I am comfortable working across the research stack, from formal problem framing and benchmark design to CUDA-level implementation, in Python, PyTorch, TensorFlow, and Hugging Face.
