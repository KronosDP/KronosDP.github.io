...
My compulsive behavior comes from the fact that I always need to check my phone to see if she has already replied to my messages. Again, itâ€™s actually not that bad if I can control it. The problem is that I still canâ€™t. I always have the urge to check my phone every 2 minutes to see if sheâ€™s already replied to my message. These kinds of compulsive behaviors can drive a girl crazy even if sheâ€™s already deeply in love with me.

## The Protocol

To address this, I wrote this blog! I want to make a protocol that I can read so that **I donâ€™t become obsessive and compulsive towards a girl**. This protocol will be followed if I find a girl I like. This protocol should be followed before you ask her to be your girlfriend. The protocol is divided into 2 categories: **first being my own filter** and **second being Godâ€™s will**.

First, letâ€™s talk about my own filter (aka my criteria)

- **Check if she motivates you to do Godâ€™s will**. It can be anything, whether to teach, do counseling, programming, or anything God wants me to do. This can be ambiguous. Because I canâ€™t know what Godâ€™s will for me is. I canâ€™t say that Godâ€™s will is what Iâ€™m mastering because sometimes itâ€™s the hard things that God wants me to do. On the other hand, it can be the more accessible, more superficial things that God wants me to do. There is no way of knowing Godâ€™s will for me isâ€¦ but Iâ€™m pretty sure God will show me the way.

- **_You're also helping her achieve what God wants HER to do_**. Itâ€™s actually the same case with the point above; itâ€™s just us playing the opposite role this time. In other words, the reverse.
...
- **Pray**. Itâ€™s not hard to do, but most people often forget it. You should ask God if sheâ€™s really the one. The answer from God can be one of these points: `Yes or yes or perhaps wait, no because I have something better for you.` Either way, the only way to know what God wants me to do is to pray every day to **ask him for the answer** and **wait for Godâ€™s timing**. You should ask God if sheâ€™s HisÂ willÂ orÂ not.
